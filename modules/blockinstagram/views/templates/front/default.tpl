	...
	<div class="row">
		{foreach $instagram_pics as $pic}
			<div class="col-xs-6 col-sm-3" style="margin-bottom:30px;">
				<a href="{$pic.link}" title="{$pic.caption|escape:'html':'UTF-8'}" target="_blank" rel="noopener" >
...
<div class="text-center">
	<a href="https://www.instagram.com/{$instagram_user.username}/" class="btn btn-primary" target="_blank" rel="noopener">
