{if $workflow == 'standard' }
	<div class="laybuy-cart-widget">
		<img style = "{$attrs['style']}" src="{$logo_url}" alt = "Laybuy" />
		Pay 6 weekly interest-free payments from <strong>{$amount}</strong>. <a href="#" class="laybuy-logo-link"><span id="laybuy-what-is-modal">&nbsp;What's this?</span></a>
	</div>
{/if}
