...
{block name='page_content'}
  ...
  {if $customer.id>696}
  <h6>{l s='If your account has been created before 20/10/2018, you can access it' d='Shop.Theme.Customeraccount'}
  <a href="http://old.gellifique.co.uk/login" target="_blank">{l s='here' d='Shop.Theme.Customeraccount'}</a>
  </h6>
  {/if}
